...
cmd({ pattern: "deepsea", alias: ["logo1"], category: "logo", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
...
cmd({ pattern: "horror", alias: ["logo2"], category: "logo", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
...
cmd({ pattern: "whitebear", alias: ["logo3"], category: "logo", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
...
cmd({ pattern: "joker", alias: ["logo4"], category: "logo", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
...
cmd({ pattern: "metallic", alias: ["logo5"], category: "logo", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
...
cmd({ pattern: "steel", alias: ["logo6"], category: "logo", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
...
cmd({ pattern: "harrypotter", alias: ["logo7"], category: "logo", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
...
cmd({ pattern: "underwater", alias: ["logo8"], category: "logo", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
...
cmd({ pattern: "luxury", alias: ["logo9"], category: "logo", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
...
cmd({ pattern: "glue", alias: ["logo10"], category: "logo", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
...
cmd({ pattern: "fabric", alias: ["logo11"], category: "logo", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
...
cmd({ pattern: "toxic", alias: ["logo12"], category: "logo", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
...
cmd({ pattern: "ancient", alias: ["logo13"], category: "logo", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
